    ...
    <section>
      <div class="page_container">
        ...
        <div class="right">
          ...
          <form action="">
            <div class="card">
              <h3 class="let">Let's do this!</h3>
              <div style="display: flex" class="flexed">
                <div class="input">
              ...
              <div style="display: flex" class="pass flexed">
                <div class="input">
                  <label for="password">PASSWORD</label><br />
                  <input type="password" id="password" required /><br />
                </div>
                <div class="input">
                  <label for="confrim">CONFIRM PASSWORD</label><br />
                  <input type="password" id="confirm" required /><br />
                </div>
              </div>
            </div>
            <button type="submit" onclick="alert('Kingsley is Awesome!')">
              Create Account
            </button>
          </form>
